            ...
            <div class="space-y-5">
              ...
              <div class="p-4 rounded-2xl bg-indigo-50/50 dark:bg-indigo-950/30 border border-indigo-100 dark:border-indigo-900/50 flex items-start gap-3 text-xs">
                ...
                <div class="space-y-1 text-slate-600 dark:text-slate-300">
                  ...
                  <div>Setelah mengisi nama klien, lanjutkan ke <b>Langkah 2</b> untuk memilih fitur software dan <b>Langkah 3</b> untuk infrastruktur hosting. Di langkah akhir, Anda dapat menentukan skema pembayaran (Beli Putus atau SaaS).</div>
                </div>
              </div>
            </div>
